...
export const CATEGORIES: CategoryInfo[] = [
    ...
    faqs: [
      {
        ...
        answer: 'Bəli. Bakı və ətraf ərazilərdə toy dekorunun hazırlanması, çatdırılması və quraşdırılması həyata keçirilir.'
      },
      {
        question: 'Toy dekoruna nələr daxildir?',
        answer: 'Standart konseptə arxa fon (altar/tağ), gəlin-bəy masası dekoru, gül kompozisiyaları, xüsusi şamlar, aksesuarlar, nəqliyyat, quraşdırma və sökülmə daxildir.'
      },
      {
        question: 'Regionlarda toy dekoru quraşdırılması necə təşkil olunur?',
        answer: 'Orta və premium toy dekor layihələri Azərbaycanın bütün bölgələrində quraşdırılır. Nəqliyyat və komanda logistikası məsafəyə uyğun olaraq şəffaf şəkildə hesablanır.'
      },
      {
        question: 'Dekor sifarişi neçə gün əvvəl verilməlidir?',
        answer: 'Xüsusi konsept və təbii güllərin sifarişi üçün ən azı 15-30 gün öncədən müraciət etməyiniz tövsiyə olunur.'
      }
    ]
  },
  {
    ...
    heroImage: 'https://images.unsplash.com/photo-1511285560929-80b456fea0bc?auto=format&fit=crop&w=1600&q=85',
    ...
    faqs: [
      {
        question: 'Nişan dekoruna nələr daxil ola bilər?',
        answer: 'Nişan dekoruna fərdi arxa fon tağı, nişan masası, zərif şamdanlar, gül kompozisiyaları, üzük və xonça stendləri, işıqlandırma və quraşdırma daxildir.'
      },
      {
        question: 'Ev şəraitində nişan dekoru quraşdırmaq mümkündür?',
        answer: 'Bəli. Məkanın ölçülərinə uyğunlaşdırılan kompakt və zərif tağ həllərimiz ev və ya həyət mərasimləri üçün ideal seçimdir.'
      },
      {
        question: 'Nişan dekorunun rəng çalarını seçmək olar?',
        answer: 'Bəli, hər bir layihə gəlinin zövqünə və geyiminə uyğun fərdi rəng palitrası ilə hazırlanır.'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    heroImage: '/images/boyuk-zal-dekor.jpg',
    ...
    seoIntroduction: 'Məkanın memarlıq xüsusiyyətlərinə uyğunlaşdırılan genişmiqyaslı zal dekorasiyası. Tavan instalyasiyaları, zərif süfrə düzümü, çilçıraq bəzəkləri və zəngin giriş dekoru.',
    metaTitle: 'Zal Dekoru və Banket Zalı Tərtibatı | DreamArt Events',
  ...
  },
  {
    ...
    seoIntroduction: 'Ənənəvi dəyərləri müasir zövqlə birləşdirən eksklüziv xonça dizaynları. Nişan, xına və digər xüsusi günləriniz üçün zərif və fərqli həllər.',
    metaTitle: 'Xonça Xidməti və Modelləri | DreamArt Events',

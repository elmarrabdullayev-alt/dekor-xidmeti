...
export const INITIAL_VENUES: VenueItem[] = [
  {
    ...
    shortDescription: 'Bakının ən nüfuzlu məkanlarından biri olan Meridian restoranında DreamArt Weddings tərəfindən icra edilmiş möhtəşəm toy və nikah dekorları.',
    ...
    seoTitle: 'Meridian Restoranı Toy Dekoru | Bakı | DreamArt Weddings',
  ...
  },
  {
    ...
    seoTitle: 'By Meridian Toy Dekoru və Ziyafət Tərtibatı | DreamArt Weddings',
  ...
  },
  {
    ...
    seoTitle: 'Bağçalı Saray Toy Dekoru və Şadlıq Zalı Tərtibatı | DreamArt Weddings',
  ...
  },
  {
    ...
    seoTitle: 'Böyük Saray Monumental Toy Dekoru və Zal Tərtibatı | DreamArt Weddings',
